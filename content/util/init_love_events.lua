...
local function handle_error (msg)
  ...
  -- reset graphics
	love.graphics.reset ()
	local error_font = love.graphics.setNewFont (math.floor (love.window.toPixels (16)))
	local source_font = love.graphics.setNewFont (math.floor (love.window.toPixels (12)))
  ...
  -- colors
  local c_dark = {96, 96, 96}
  local c_mid = {150, 150, 150}
  local c_bright = {240, 240, 240}
  local c_interact = {240, 240, 240}
